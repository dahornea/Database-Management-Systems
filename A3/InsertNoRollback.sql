...
GO
CREATE OR ALTER PROCEDURE successfullAddNoRollback AS
BEGIN
...
EXEC successfullAddNoRollback
EXEC failAddNoRollback

SELECT * FROM Fish
SELECT * FROM FishTanks
SELECT * FROM FishInFishTanks
SELECT * FROM LogChanges
DELETE FROM FishInFishTanks
